"""
Continuous-Orthogonal Mode Decomposition (C-OMD) and the VMD baseline.
...
__all__ = ["COMDConfig", "comd", "vmd", "newton_schulz_orthogonalize", "gram_matrix"]
...
# --------------------------------------------------------------------------- #
def vmd(f: np.ndarray, K: int = 3, alpha_vmd: float = 2000.0, tau: float = 0.0,
